...
**Convites das etapas** — cria os convites das etapas do Lead Time na agenda do consultor, com Meet, avisando os convidados. A coordenação (`SEMPRE_OBRIGATORIO`) e o designer do projeto entram como obrigatórios, com o e-mail resolvido pela tabela `usuarios` no servidor — não pelo navegador. Quem conectou o Google antes de 23/09/2026 tem só o escopo de leitura guardado: a primeira tentativa devolve 409 pedindo pra sair e entrar de novo, e o `prompt=consent` do login reemite o token com o escopo de escrita.
