...
- **d4 — Tradução técnica → negócio:** personalização dos dados, consequência financeira em reais, continuidade. *(Gap mais recorrente da squad — verificar sempre se os achados foram fechados em números concretos, não só qualitativos. **Exigência varia por tipo de entrega:** em Diagnóstico de Vendas e Apresentação Final/Plano de Decolagem, o padrão é rígido — o componente "consequência financeira em reais" só é Pleno se o achado foi de fato fechado num número (ex: "isso representa R$X/mês"), usando dado real do cliente. Em Kickoff, Pesquisa de Mercado, Diagnóstico de Mídia Paga e Análise de Ambientes, o princípio é outro: o que se avalia é a TENTATIVA genuína de puxar o teor financeiro do achado junto ao cliente, não o resultado fechado — nem sempre vai dar pra chegar num número exato, porque depende da informação que o cliente tem disponível naquele momento, e isso não é falha do consultor. Pleno quando o consultor pergunta/busca ativamente o dado financeiro ligado a um achado (ex.: "quanto isso representa hoje em receita/custo?", "qual o impacto disso no seu resultado?"), mesmo que a resposta do cliente saia vaga, incompleta ou sem número redondo — o que conta é ter buscado, não ter fechado. Parcial quando o consultor só nomeia que o achado tem peso financeiro, sem de fato perguntar/buscar o dado com o cliente. Ausente quando o achado é citado sem nenhuma tentativa de conexão com consequência financeira. Essa lógica de "tentativa pesa mais que resultado fechado" vale igual pros quatro tipos, **incluindo Kickoff** — não existe um tratamento ainda mais brando só pro Kickoff nesse componente. A diferença real do Kickoff pros demais é de contexto, não de régua: como é o primeiro encontro, raramente existe um "achado" já fechado pra puxar consequência em cima — o que se espera em vez disso é que o consultor pergunte pelos números-base do negócio (faturamento, ticket médio, meta, verba, CAC etc.), matéria-prima financeira que vai virar tradução de consequência nas entregas seguintes.)*
