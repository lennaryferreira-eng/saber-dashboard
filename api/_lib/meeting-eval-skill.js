...
- **d4 — Tradução técnica → negócio:** personalização dos dados, consequência financeira em reais, continuidade. *(Gap mais recorrente da squad — verificar sempre se os achados foram fechados em números concretos, não só qualitativos. **Exigência varia por tipo de entrega:** em Diagnóstico de Vendas e Apresentação Final/Plano de Decolagem, o padrão é rígido — o componente "consequência financeira em reais" só é Pleno se o achado foi de fato fechado num número (ex: "isso representa R$X/mês"), usando dado real do cliente. Em Kickoff, Pesquisa de Mercado, Diagnóstico de Mídia Paga e Análise de Ambientes, esse componente é avaliado de forma mais branda: o objetivo nessas entregas é reforçar a importância da tradução financeira, não fechar a conta completa — considere Pleno quando o consultor nomeia explicitamente que um achado tem peso/consequência financeira (mesmo sem calcular o valor exato, ex: "isso é receita que pode estar escapando"), Parcial quando a menção ao impacto de negócio é genérica ("isso é importante"), e Ausente só quando o achado é citado sem nenhuma conexão a consequência de negócio.)*
- **d5 — Arquitetura de urgência:** custo da inação no presente (não só oportunidade futura), momentum, roadmap como âncora temporal. *(Segundo gap mais recorrente. **Exigência varia por tipo de entrega:** em Diagnóstico de Vendas e Apresentação Final/Plano de Decolagem, mantém o padrão rígido — exige custo da inação hoje, não só projeção futura, sob pena de Ausente/Parcial. Em Kickoff, Pesquisa de Mercado, Diagnóstico de Mídia Paga e Análise de Ambientes, usar o roadmap até o Plano de Decolagem como âncora temporal é esperado e correto — não penalize só por a entrega sinalizar que a solução completa vem lá. Mas só é Pleno se, além de reforçar isso, a entrega TAMBÉM deixar pelo menos uma ação prática e paliativa que o cliente já consiga aplicar agora, antes do Plano de Decolagem chegar — mesmo que pequena ou provisória. É Parcial quando só aponta o achado urgente sem paliativo nenhum; é Ausente quando nem sinaliza a urgência do achado. Se faltar o paliativo, o "Plano de ação:" dessa dimensão deve sugerir explicitamente qual seria essa ação imediata.)*
